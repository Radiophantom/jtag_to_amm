...
assign mst_mem_if.readdatavalid  = slv_mem_readdatavalid [current_slave_index];
assign mst_mem_if.readdata       = slv_mem_readdata      [current_slave_index];
assign mst_mem_if.waitrequest    = slv_mem_waitrequest   [current_slave_index];
